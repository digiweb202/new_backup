...
$sql = "SELECT  o.order_new_id,o.order_date,o.shipping_address,o.state,c.customer_name,c.customer_email,c.customer_mobile, p.product_name,od.price,od.quantity,od.sub_total,od.cgst,od.sgst,od.igst,od.tcs_cgst,od.tcs_sgst,od.tcs_igst,od.tds,od.total from order_new o
inner JOIN
customer c on o.customer_id=c.customer_id 
inner join
order_item od on o.order_new_id=od.order_id 
inner join
product p on od.product_id=p.product_id where status='$_GET[status]' and p.vendor_id='$vid'
...
fputcsv($handle, array('Order ID / Invoice Number', 'Order date','Address','state','Customer Name','Customer Email','Customer Mobile', 'Product name','Product Price','quantity','sub_total','CGST','SGST','IGST','TCS_CGST','TCS_SGST','TCS_IGST','TDS','Final Amount'));
