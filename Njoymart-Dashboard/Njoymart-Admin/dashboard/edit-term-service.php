...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = $_POST['id'];
    $title = $_POST['title'];
    $link = $_POST['paragraph'];

    $sql = "UPDATE terms_service SET title='$title', paragraph='$link' WHERE id=$id";

    if ($conn->query($sql) === TRUE) {
        echo "Record updated successfully";
        // Redirect to main-menu.php after successful update
        header("Location: term-service.php");
        exit();
    } else {
...
if ($id) {
    $sql = "SELECT * FROM terms_service WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingTitle = $row['title'];
        $existingParagraph = $row['paragraph'];
    } else {
        echo "Data not found.";
        exit;
    }
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Update Term & Service</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="term-service.php" class="text-inherit">Term & Service</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update Term & Service</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="term-service.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Term & Service</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="title" name="title" value="<?php echo isset($existingTitle) ? $existingTitle : ''; ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="paragraph" class="form-label">Enter Paragraph:</label>
                                                    <textarea class="form-control" id="paragraph" name="paragraph" rows="4"><?php echo isset($existingParagraph) ? $existingParagraph : ''; ?></textarea>
                                                </div>
