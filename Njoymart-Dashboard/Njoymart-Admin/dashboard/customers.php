            ...
            <div class="container">
                                ...
                                <div class="p-6">
                                    <div class="row justify-content-between">
                                        <div class="col-md-4 col-12">
                                            <form class="d-flex" role="search" action="customers.php?search" method="GET">
                ...
                <?php
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM nw_customer WHERE id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <?php
                                            $select_customer = "SELECT * FROM nw_customer";
                                            $res_select_customer = $conn->query($select_customer);

                                            if ($res_select_customer) {
                                            ?>
                                                <tbody>
                                                    <?php while ($row = mysqli_fetch_assoc($res_select_customer)) { ?>
                                                        <tr>
                                                            <td>
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" value="" id="customerOne">
                                                            ...
                                                            <!-- <td>
                                                                <?php
                                                                // $spent = "SELECT SUM(total_price) AS spent_amt FROM order_new o INNER JOIN nw_customer c ON c.id=o.customer_id WHERE o.customer_id='" . $row['id'] . "'";
                                                                // $res_spent = $conn->query($spent);
                                                                // if ($res_spent) {
                                                                //     $row_res_spent = mysqli_fetch_assoc($res_spent);
                                                                //     echo $row_res_spent['spent_amt'];
                                                                // } else {
                                                                //     echo "Error fetching spent amount";
                                                                // }
                                                                ?>
                                                            </td> -->
                                                            <td>
                                                                <div class="dropdown">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit-customers.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
