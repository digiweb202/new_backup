                    ...
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/footer-links.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                                    <span class="nav-link-text">Footer Contact</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item ">
            ...
            <div class="container">
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Footer Contact</li>
                                    </ol>
                                </nav>
                            </div>
                            <div>
                                ...
                                <!-- <a href="add-featured-icon.php" class="btn btn-primary">Add New Footer Contact</a> -->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM contact_information WHERE id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from contact_information";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img style="width:200px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/icons/<?php echo $row['icon']; ?>" alt="img" class="icon-shape icon-md">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit_footer_contact.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
