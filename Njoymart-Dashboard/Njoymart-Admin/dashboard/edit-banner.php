...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        $id = $_POST['id'];
        $targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/slider/";
        ...
        if ($uploadOk !== 0) {
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
                ...
                $sql = "UPDATE banner SET banner_title = '$title', banner_image = '$fileName' WHERE banner_id = $id";
...
$id = isset($_GET['banner_id']) ? $_GET['banner_id'] : null;
if ($id) {
    $sql = "SELECT * FROM banner WHERE banner_id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingTitle = $row['banner_title'];
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="products.php" class="text-inherit">Banner</a></li>
                                ...
                                <!-- button -->
                                <div>
                                    <a href="banner.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?php echo isset($_GET['banner_id']) ? $_GET['banner_id'] : ''; ?>">
