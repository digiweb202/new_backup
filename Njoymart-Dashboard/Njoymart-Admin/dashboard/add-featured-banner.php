...
if (isset($_POST["submit"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
            ...
            $sql = "INSERT INTO cart_banner_3 (text, image, link) VALUES ('$title', '$fileName', '$link')";
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Add New Featured Banner</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
