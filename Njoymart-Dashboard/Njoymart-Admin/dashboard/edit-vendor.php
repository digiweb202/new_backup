...
// Retrieve the customer details for pre-filling the form
...
if ($id) {
    ...
    if ($result->num_rows > 0) {
        ...
        $vendor_front_pan_img = $row['vendor_pan_front_img'];
        $vendor_back_pan_img = $row['vendor_pan_back_img'];
        $vendor_store_image = $row['vendor_store_image'];
    } else {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($id)) {
        ...
        $vendor_pan_front_img = $_POST['vendor_front_img_pan'];
        $vendor_pan_back_img = $_POST['vendor_Back_img_pan'];

        $sql = "UPDATE vendor SET vendor_name='$vendor_name', brand_name='$brand_name', vendor_pan_num='$vendor_pan', vendor_email='$vendor_email', vendor_mobile='$vendor_mobile', vendor_password='$vendor_password', vendor_address='$vendor_address', vendor_city='$vendor_city', vendor_state='$vendor_state', vendor_status='$vendor_status', vendor_Logo='$vendor_Logo', vendor_store_image='$vendor_store_image',vendor_pan_front_img='$vendor_pan_front_img',vendor_pan_back_img='$vendor_pan_back_img' WHERE vendor_id=$id";
...
// /// Retrieving the existing customer details
// $id = isset($_GET['vendor_id']) ? $_GET['vendor_id'] : null;
// if ($id) {
//     $sql = "SELECT * FROM vendor WHERE vendor_id = $id";
//     $result = $conn->query($sql);
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="vendor.php" class="text-inherit">Vendor</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update Vendor Details</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Vendor PAN:<br>
                                                <input type="text" name="vendor_pan" value="<?php echo $vendor_pan; ?>">
                                                <br><br>
                                                Vendor Email:<br>
                                                <input type="text" name="vendor_email" value="<?php echo $vendor_email; ?>">
                                                <br><br>
                                                Vendor Mobile:<br>
                                                <input type="text" name="vendor_mobile" value="<?php echo $vendor_mobile; ?>">
                                                <br><br>
                                                Vendor Password:<br>
                                                <input type="text" name="vendor_password" value="<?php echo $vendor_password; ?>">
                                                <br><br>
                                                Vendor Address:<br>
                                                <input type="text" name="vendor_address" value="<?php echo $vendor_address; ?>">
                                                <br><br>
                                                Vendor City:<br>
                                                <input type="text" name="vendor_city" value="<?php echo $vendor_city; ?>">
                                                <br><br>
                                                Vendor State:<br>
                                                <input type="text" name="vendor_state" value="<?php echo $vendor_state; ?>">
                                                <br><br>
                                                Vendor Status:<br>
                                                <select name="vendor_status">
                                                    <option value="rejected" <?php if ($vendor_status == 'rejected') echo 'selected="selected"'; ?>>Active</option>
                                                    <option value="pending" <?php if ($vendor_status == 'pending') echo 'selected="selected"'; ?>>Pending</option>
                                                    <option value="registered" <?php if ($vendor_status == 'registered') echo 'selected="selected"'; ?>>registered</option>

                                                </select>
                                                <br><br>

                                                Vendor Logo:<br>
                                                <input type="text" name="vendor_Logo" value="<?php echo $vendor_Logo; ?>">
                                                <br><br>
                                                Vendor Store Image:<br>
                                                <!-- deepcode ignore XSS: <please specify a reason of ignoring this> -->
                                                <input type="text" name="vendor_store_image" value="<?php echo $vendor_store_image; ?>">
                                                <br><br>
                                                Vendor PanCard Front Image:<br>
                                                <!-- deepcode ignore XSS: <please specify a reason of ignoring this> -->
                                                <input type="text" name="vendor_front_img_pan" value="<?php echo $vendor_front_pan_img; ?>">
                                                <br><br>
                                                Vendor PanCard Back Image:<br>
                                                <!-- deepcode ignore XSS: <please specify a reason of ignoring this> -->
                                                <input type="text" name="vendor_Back_img_pan" value="<?php echo $vendor_back_pan_img; ?>">
                                                <br><br>
