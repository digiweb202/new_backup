...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = $_POST['link'];
    $password = $_POST['password']; // Ensure the password field matches the form field name
    $customerNumber = $_POST['subMenu']; // Ensure the customer number field matches the form field name
    ...
    if ($result_username->num_rows > 0 && $result_email->num_rows > 0) {
        ...
        // If the username and email don't exist, perform the insertion
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/customer.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-star"></i></span>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="customer.php" class="text-inherit">Customer</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="number" name="subMenu" pattern="\d+" title="Please enter a valid number." required>
                                                <br><br>
