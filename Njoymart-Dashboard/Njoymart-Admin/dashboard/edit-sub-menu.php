...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = $_POST['id'];
    $title = $_POST['mainmenuid'];
    $link = $_POST['pagename'];
    $subMenu = $_POST['pagelink'];

    $sql = "UPDATE sub_menu SET main_menu_id='$title', name='$link', link='$subMenu' WHERE id=$id";
...
if ($id) {
    ...
    if ($result->num_rows > 0) {
        ...
        $existingMainMenuId = $row['main_menu_id'];
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="main-menu.php" class="text-inherit">Sub Menu</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update Sub Menu</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="sub-menu.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                Enter Main Menu Id:<br>
                                                <input type="text" name="mainmenuid" value="<?php echo isset($existingMainMenuId) ? $existingMainMenuId : ''; ?>">
                                                <br><br>
                                                Enter Page Name:<br>
                                                <input type="text" name="pagename" value="<?php echo isset($existingName) ? $existingName : ''; ?>">
                                                <br><br>
                                                Enter Page Link:<br>
                                                <input type="text" name="pagelink" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
