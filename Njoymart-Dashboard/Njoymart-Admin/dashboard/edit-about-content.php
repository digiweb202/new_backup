...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $sql = "UPDATE about_content SET title = '$title', content_1 = '$contentone', content_2 = '$contenttwo' WHERE id = $id";

        if ($conn->query($sql) === TRUE) {
            echo "Record updated successfully";
            if (isset($_FILES["fileToUpload"]["name"]) && !empty($_FILES["fileToUpload"]["name"])) {
                $targetDir = "D:/xampp/htdocs/hit/Njoymart-Dashboard/Njoymart-Admin/dashboard/imgs/about_assets/";
                ...
                if ($uploadOk !== 0) {
                    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
                        ...
                        $sql = "UPDATE about_content SET title = '$title', content_1 = '$contentone', content_2 = '$contenttwo', image_path = '$fileName' WHERE id = $id";
                ...
                echo "Record updated successfully without uploading the file";
                header("Location: about-content.php");
                exit;
            }
        } else {
        ...
        echo "About Content ID is missing.";
    }
}
...
if ($id) {
    ...
    if ($result->num_rows > 0) {
        ...
        $existingContent1 = $row['content_1'];
        $existingContent2 = $row['content_2'];
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/about-content.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="products.php" class="text-inherit">About Content </a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update About Content</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="about-content.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">About Content</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Enter title:<br>
                                                <input type="text" name="title" value="<?php echo isset($existingTitle) ? $existingTitle : ''; ?>">
                                                <br><br>
                                                Current Content1 : <br>
                                                <input type="text" name="contentone" value="<?php echo isset($existingContent1) ? $existingContent1 : ''; ?>">
                                                <br><br>
                                                Current Content2 : <br>
                                                <input type="text" name="contenttwo" value="<?php echo isset($existingContent2) ? $existingContent2 : ''; ?>">
                                                <br><br>
