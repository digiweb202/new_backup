...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $title = $_POST['title'];
    $pageLink = $_POST['link']; // replace 'link' with the actual name attribute of the input field for page link
    $pageSubMenu = $_POST['subMenu']; // replace 'subMenu' with the actual name attribute of the input field for page sub-menu

    // Check if the title already exists
    $check_query = "SELECT * FROM main_menu WHERE name = '$title'";
    $result = $conn->query($check_query);

    if ($result->num_rows > 0) {
        echo "Error: Title already exists. Please use a different title.";
    } else {
        // If the title doesn't exist, perform the insertion
        $sql = "INSERT INTO main_menu (name, link, sub_menu) VALUES ('$title', '$pageLink', '$pageSubMenu')";
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="products.php" class="text-inherit">Menu</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Enter Page SubMenu (Only numbers):
