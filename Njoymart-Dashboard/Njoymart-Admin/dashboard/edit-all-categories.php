...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $sql = "UPDATE all_browse_categories SET name = '$title', link = '$link' WHERE id = $id";
        ...
        if ($_FILES["fileToUpload"]["name"]) {
            $targetDir = "assets/imgs/theme/icons/"; // Change this to the appropriate web-accessible directory
            ...
            if ($uploadOk !== 0) {
                if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
                    ...
                    $updateImageQuery = "UPDATE all_browse_categories SET image = '$fileName' WHERE id = $id";

                    if ($conn->query($updateImageQuery) === TRUE) {
                        echo "Image updated successfully";
                    } else {
                        echo "Error: " . $updateImageQuery . "<br>" . $conn->error;
                    }
                } else {
...
if ($id) {
    $sql = "SELECT * FROM all_browse_categories WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingTitle = $row['name'];
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active " href="../dashboard/all-categories.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="all-categories.php" class="text-inherit">All Categories</a></li>
                                ...
                                <!-- button -->
                                <div>
                                    <a href="all-categories.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                Enter Name:<br>
                                                <input type="text" name="name" value="<?php echo isset($existingTitle) ? $existingTitle : ''; ?>">
                                                <br><br>
                                                Enter Link:<br>
                                                <input type="text" name="link" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
                                                Select image to upload (Optional):<br>
