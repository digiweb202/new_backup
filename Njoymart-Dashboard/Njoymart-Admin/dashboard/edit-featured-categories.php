...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/shop/";
...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE featured_categories SET category_name=?, item_count=?, categories_link=?" . ($fileName ? ", image=?" : "") . " WHERE category_id=?");
        if ($fileName) {
            $stmt->bind_param("ssssi", $title, $count, $link, $fileName, $id);
        } else {
            $stmt->bind_param("sssi", $title, $count, $link, $id);
        }
        ...
        if ($stmt->execute()) {
            ...
            header("Location: featured-categories.php");
            exit();
        } else {
...
// Retrieve the existing category details for pre-filling the form
$id = isset($_GET['category_id']) ? $_GET['category_id'] : null;
if ($id) {
    $sql = "SELECT * FROM featured_categories WHERE category_id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $existingText = $row['category_name'];
        $existingCount = $row['item_count'];
        $existingLink = $row['categories_link'];
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/featured-categories.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Add New Featured Categories</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="dbs-card-banner.php" class="text-inherit">Featured Categories</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New Featured Categories</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="featured-categories.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Featured Categories</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                <input type="hidden" name="id" value="<?php echo isset($_GET['category_id']) ? $_GET['category_id'] : ''; ?>">
                                                Enter Categories Name:
                                                <input type="text" name="title" value="<?php echo isset($existingText) ? $existingText : ''; ?>">
                                                <br><br>
                                                Enter Link:<br>
                                                <input type="text" name="link" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
                                                Enter Item Count:
                                                <input type="text" name="itemcount" value="<?php echo isset($existingCount) ? $existingCount : ''; ?>">
                                                <br><br>
