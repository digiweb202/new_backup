...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/shop/"; // specify the directory where you want to store the uploaded files
...
if (isset($_POST["submit"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
            ...
            $title = $_POST['title'];
            $link = $_POST['link'];
            $itemcount = $_POST['itemcount']; // Added line for the link

            $sql = "INSERT INTO featured_categories (category_name, item_count ,image,categories_link) VALUES ('$title','$itemcount','$fileName',  '$link')";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Enter Link:
                                                <input type="text" name="link" aria-rowspan="" required>
                                                <br><br>
                                                Enter Item Count:
