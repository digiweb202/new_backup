...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO sub_menu (main_menu_id, name, link) VALUES ('$main_menu_id', '$name', '$link')";
...
// Fetch all main menu IDs and names
$sql = "SELECT id, name FROM main_menu";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        $menuOptions .= '<option value="' . $row['id'] . '">' . $row['id'] . ' - ' . $row['name'] . '</option>';
    }
} else {
    echo "0 results";
}
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="products.php" class="text-inherit">Sub Menu</a></li>
