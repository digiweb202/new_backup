...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/slider/"; // specify the directory where you want to store the uploaded files
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="products.php" class="text-inherit">Products</a></li>
