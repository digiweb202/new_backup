...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE cart_banner_3 SET text=?, link=?" . ($fileName ? ", image=?" : "") . " WHERE id=?");
        if ($fileName) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: featured-banner.php");
        } else {
...
if ($id) {
    $sql = "SELECT * FROM cart_banner_3 WHERE id = $id";
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/featured-banner.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Update Featured Banner</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="featured-banner.php" class="text-inherit">Featured Banner</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update Featured Banner</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="featured-banner.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Featured Banner</h4>
                                    <div class="row">
                                        <!-- input -->
