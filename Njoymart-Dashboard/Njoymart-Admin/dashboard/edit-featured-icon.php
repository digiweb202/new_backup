...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/icons/"; // specify the directory where you want to store the uploaded files
...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE featured_icons SET title=?, description=?" . ($fileName ? ", icon_url=?" : "") . " WHERE id=?");
        if ($fileName) {
            $stmt->bind_param("sssi", $title, $link, $fileName, $id);
        } else {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: featured-icon.php");
        } else {
            echo "Error: " . $stmt->error;
        }
        $stmt->close();
    } else {
        echo "Banner ID is missing.";
    }
}
...
if ($id) {
    $sql = "SELECT * FROM featured_icons WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingText = $row['title'];
        $existingLink = $row['description'];
        $existingImage = $row['icon_url'];
    } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Add New Featured Card</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="featured-icon.php" class="text-inherit">Featured Card</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New Featured Card</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="featured-icon.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Featured Card</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                Enter Description:
                                                <input type="text" name="description" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
