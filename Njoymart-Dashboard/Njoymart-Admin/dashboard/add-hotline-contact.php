...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $hotline_number = $_POST['hotline_number']; // replace 'hotline_number' with the actual name attribute of the input field for hotline number
    $support_hours = $_POST['support_hours']; // replace 'support_hours' with the actual name attribute of the input field for support hours

    // Check if the hotline number already exists
    $check_query = "SELECT * FROM hotline_table WHERE hotline_number = '$hotline_number'";
    $result = $conn->query($check_query);

    if ($result->num_rows > 0) {
        echo "Error: Hotline number already exists. Please use a different hotline number.";
    } else {
        // If the hotline number doesn't exist, perform the insertion
        $sql = "INSERT INTO hotline_table (hotline_number, support_hours) VALUES ('$hotline_number', '$support_hours')";

        if ($conn->query($sql) === TRUE) {
            echo "New record created successfully";
            header("Location: hotline-contact.php");
            exit();
        } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Add New Hotline Contact</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="hotline-contact.php" class="text-inherit">Hotline Contact</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New Hotline Contact</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="main-menu.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">hotline number</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">

                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                                Enter hotline number:<br>
                                                <input type="text" name="hotline_number" required>
                                                <br><br>
                                                Enter support hours:<br>
                                                <input type="text" name="support_hours" required>
                                                <br><br>
