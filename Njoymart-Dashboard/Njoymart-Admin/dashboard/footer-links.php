...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link  active " href="../dashboard/footer-links.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
            ...
            <div class="container">
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Footer Pages</li>
                                    </ol>
                                </nav>
                            </div>
                            <div>
                                ...
                                <a href="add-footer-links.php" class="btn btn-primary">Add New Customer</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-6">
                                    <div class="row justify-content-between">
                                        <div class="col-md-4 col-12">
                                            <!-- <form class="d-flex" role="search" action="featured-icon.php?search" method="GET">
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM footer_links WHERE id = $delete_id";
                        ...
                        <div class="col-xl-12 col-12 mb-5">
                            <div class="card h-100 card-lg">
                                <div class="p-6">
                                    <div class="row justify-content-between">
                                        <div class="col-md-4 col-12">
                                            <!-- <form class="d-flex" role="search" action="footer-links.php?search" method="GET">
                                                <input class="form-control" type="search" placeholder="Search Customers" aria-label="Search" name="search" id="search">
                                            </form> -->
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from footer_links";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="ms-2">
                                                                    <a href="#" class="text-inherit"><?php echo $row['id']; ?></a>
                                                                </div>
                                                            </div>
                                                        </td>

                                                        <!-- <td>
                                                            <img style="width:200px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/icons/
                                                            <?php
                                                            //  echo $row['icon_url']; 
                                                            ?>" alt="img" class="icon-shape icon-md">
                                                        </td> -->
                                                        ...
                                                        <td>
                                                            ...
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="#">Company</li>
                                                                    <li><a class="dropdown-item" href="#">Account</li>
                                                                    <li><a class="dropdown-item" href="#">Corporate</li>
                                                                    <li><a class="dropdown-item" href="#">Popular</li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="?delete=<?php echo $row['id']; ?>"><i class="bi bi-trash me-3"></i>Delete</a></li>
                                                                    <li><a class="dropdown-item" href="edit-footer-links.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
