...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO footer_links (link_name, link_url, title_tag) VALUES ('$title','$itemcount','$titletag')";

    if ($conn->query($sql) === TRUE) {
        echo "New record created successfully";
        echo "<script>alert('Data uploaded successfully!');</script>"; // JavaScript alert after successful data upload
    } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Add New Featured Pages</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="footer-links.php" class="text-inherit">Featured Page</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New Featured Page</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
