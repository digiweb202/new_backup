...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = $_POST['id'];
    $username = $_POST['username_nw'];
    $email = $_POST['email'];
    $password = $_POST['password'];
    $customerNumber = $_POST['customer_number'];

    $stmt = $conn->prepare("UPDATE nw_customer SET username=?, email=?, password=?, customer_number=? WHERE id=?");
    $stmt->bind_param("ssssi", $username, $email, $password, $customerNumber, $id);

    if ($stmt->execute()) {
        $stmt->close();
        // Redirect to main-menu.php after successful update
...
// Retrieve the existing banner details for pre-filling the form
$id = isset($_GET['id']) ? $_GET['id'] : null;
if ($id) {
    $sql = "SELECT * FROM nw_customer WHERE id = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        $existingCustomerNumber = $row['customer_number'];
    } else {
        echo "Data not found.";
        exit;
    }
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="customers.php" class="text-inherit">Customer</a></li>
                                ...
                                <!-- button -->
                                <div>
                                    <a href="customers.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Customer Details</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Enter UserName:</label>
                                                    <input type="text" class="form-control" id="title" name="username_nw" value="<?php echo isset($existingUsername) ? $existingUsername : ''; ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="paragraph" class="form-label">Enter Email:</label>
                                                    <textarea class="form-control" id="paragraph" name="email" rows="4"><?php echo isset($existingEmail) ? $existingEmail : ''; ?></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="title" class="form-label">Enter Password:</label>
                                                    <input type="text" class="form-control" id="title" name="password" value="<?php echo isset($existingPassword) ? $existingPassword : ''; ?>">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="paragraph" class="form-label">Enter Customer Number:</label>
                                                    <textarea class="form-control" id="paragraph" name="customer_number" rows="4"><?php echo isset($existingCustomerNumber) ? $existingCustomerNumber : ''; ?></textarea>
                                                </div>
