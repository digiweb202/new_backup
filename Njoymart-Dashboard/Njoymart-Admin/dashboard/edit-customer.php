...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $link = $_POST['email'];
    $subMenu = $_POST['number'];
    $password = $_POST['password'];


    $sql = "UPDATE nw_customer SET username='$title', email='$link', customer_number='$subMenu',password='$password' WHERE id=$id";
...
if ($id) {
    $sql = "SELECT * FROM nw_customer WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingUsername = $row['username'];
        $existingEmail = $row['email'];
        $existingNumber = $row['customer_number'];
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                Enter Username:<br>
                                                <input type="text" name="username" value="<?php echo isset($existingUsername) ? $existingUsername : ''; ?>">
                                                <br><br>
                                                Enter Email:<br>
                                                <input type="text" name="email" value="<?php echo isset($existingEmail) ? $existingEmail : ''; ?>">
                                                <br><br>
                                                Enter Number:<br>
                                                <input type="text" name="number" value="<?php echo isset($existingNumber) ? $existingNumber : ''; ?>">
                                                <br><br>
                                                Enter Password:<br>
                                                <input type="text" name="password" value="<?php echo isset($existingPass) ? $existingPass : ''; ?>">
                                                <br><br>
