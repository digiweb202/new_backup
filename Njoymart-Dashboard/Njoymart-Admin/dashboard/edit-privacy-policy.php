...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE privacy_policy SET title='$title', paragraph='$link' WHERE id=$id";
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="privacy-policy.php" class="text-inherit">Privacy Policy</a></li>
                                ...
                                <!-- button -->
                                <div>
                                    <a href="privacy-policy.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Privacy Policy</h4>
                                    <div class="row">
                                        <!-- input -->
