...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/banner/";
...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE newsletter_content SET heading=?, description=?" . ($fileName ? ", image_url=?" : "") . " WHERE id=?");
        if ($fileName) {
        ...
        if ($stmt->execute()) {
            ...
            header("Location: news-letter-banner.php");
        } else {
...
if ($id) {
    $sql = "SELECT * FROM newsletter_content WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingText = $row['heading'];
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/news-letter-banner.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Add New News Letter Banner</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="news-letter-banner.php" class="text-inherit">News Letter Banner</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New News Letter Banner</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="news-letter-banner.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">News Letter Banner</h4>
                                    <div class="row">
                                        <!-- input -->
