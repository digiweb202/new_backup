...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    $id = $_POST['id'];
    $title = $_POST['hotline_number'];
    $link = $_POST['support_hours'];


    $sql = "UPDATE hotline_table SET hotline_number='$title', support_hours='$link' WHERE id=$id";
...
if ($id) {
    $sql = "SELECT * FROM hotline_table WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingName = $row['hotline_number'];
        $existingLink = $row['support_hours'];
    } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Update HotLine Contact</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="main-menu.php" class="text-inherit">HotLine Contact</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update HotLine Contact</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="hotline-contact.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Hotline Contact</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="text" name="hotline_number" value="<?php echo isset($existingName) ? $existingName : ''; ?>">
                                                <br><br>
                                                Enter Page Link:<br>
                                                <input type="text" name="support_hours" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
