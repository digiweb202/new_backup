...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/hotline_contact.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-star"></i></span>
            ...
            <div class="container">
                <div class="row mb-8">
                    <div class="col-md-12">
                        <div class="d-md-flex justify-content-between align-items-center">
                            <div>
                                <h2>HotLine Contact</h2>
                                <!-- breacrumb -->
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item"><a href="#" class="text-inherit">Dashboard</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">HotLine Contact</li>
                                    </ol>
                                </nav>
                            </div>
                            <div>
                                ...
                                <a href="add-hotline-contact.php" class="btn btn-primary">Add New HotLine Contact</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM hotline_table WHERE id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from hotline_table";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['support_hours']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit-hotline-contact.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
