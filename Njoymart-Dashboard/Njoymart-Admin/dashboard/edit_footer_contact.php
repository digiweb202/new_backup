...
<?php
$targetDir = "D:/xampp/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/icons/"; // specify the directory where you want to store the uploaded files
...
if ($id) {
    $sql = "SELECT * FROM contact_information WHERE id = $id";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        $existingText = $row['title'];
        $existingLink = $row['content'];
...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        // Uncomment the next lines to handle file upload
        ...
        $title = $_POST['title'];
        $link = $_POST['content']; // Change 'content' to 'description'

        // Use prepared statements to prevent SQL injection
        $stmt = $conn->prepare("UPDATE contact_information SET title=?, content=?" . ($fileName ? ", icon=?" : "") . " WHERE id=?");
        if ($fileName) {
            $stmt->bind_param("sss", $title, $link, $fileName, $id);
        } else {
...
<a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                ...
                <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                    <ul class="navbar-nav flex-column" id="sideNavbar">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link active" href="../dashboard/featured-icon.php">
                                <div class="d-flex align-items-center">
                                    <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="footer_contact.php" class="text-inherit">Footer Content</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Add New Footer Content</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="footer_contact.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Footer Content</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Title: <input type="text" name="title" style="width: 100%; box-sizing: border-box;" value="<?php echo isset($existingText) ? $existingText : ''; ?>">
                                                <br><br>
                                                Enter Content:<br>
                                                <input type="text" name="content" style="width: 100%; box-sizing: border-box;" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
                                                <!-- Uncomment the next line to allow file uploads -->
