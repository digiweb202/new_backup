        ...
        <main class="main-content-wrapper">
            <div class="container">
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">Vendor Logo</li>
                                    </ol>
                                </nav>
                            </div>
                            <div>
                                ...
                                <!-- <a href="add-logo.php" class="btn btn-primary">Add New logo</a> -->
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                    ...
                    //     $vendor_id = $_GET['vendor_id'];
                    //     // $delete_query = "DELETE FROM vendor WHERE vendor_id=$vendor_id";
                    ...
                    //         // Deleting the vendor logo field
                    //         $update_query = "UPDATE vendor SET vendor_Logo = 'Testing12' WHERE vendor_id=$vendor_id";
                    //         $stmt = $conn->prepare($update_query);
                    //         // $stmt->bind_param("i", $delete_id);

                    //         if ($stmt->execute()) {
                    //             // echo "Vendor logo field deleted successfully";
                    //         } else {
                    //             echo "Error deleting vendor logo field: " . $conn->error;
                    //         }
                    //     // } else {
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <img style="width:200px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/vendor/vendor_logos/<?php echo $row['vendor_Logo']; ?>" alt="img" class="icon-shape icon-md">
                                                            </td>
                                                            <td>
                                                                <div class="dropdown">
                                                                    <a href="#" class="text-reset" data-bs-toggle="dropdown" aria-expanded="false">
                                                                    ...
                                                                    <ul class="dropdown-menu">
                                                                        ...
                                                                        <li><a class="dropdown-item" href="edit-logo.php"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                    </ul>
                                                                </div>
                                                            </td>
                                                        </tr>
