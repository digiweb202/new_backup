...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["submit"], $_POST['id'])) {
    ...
    if (!empty($_FILES["fileToUpload"]["name"])) {
        $targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/vendor/vendor_banner/";
    ...
    $stmt = $conn->prepare("UPDATE vendor SET vendor_store_image=? WHERE vendor_id=?");
...
if ($vendor_ids) {
    ...
    if ($result->num_rows > 0) {
        ...
        $existingImage = $row['vendor_store_image'];
    } else {
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="banner.php" class="text-inherit">Banner</a></li>
