...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE main_menu SET name='$title', link='$link', sub_menu='$subMenu' WHERE id=$id";
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="main-menu.php" class="text-inherit">Menu</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                Enter Page Name:<br>
                                                <input type="text" name="title" value="<?php echo isset($existingName) ? $existingName : ''; ?>">
                                                <br><br>
                                                Enter Page Link:<br>
                                                <input type="text" name="link" value="<?php echo isset($existingLink) ? $existingLink : ''; ?>">
                                                <br><br>
                                                Enter Page SubMenu (Only numbers):
                                                <input type="number" name="subMenu" pattern="\d+" title="Please enter a valid number." value="<?php echo isset($existingSubmen) ? $existingSubmen : ''; ?>">
                                                <br><br>
