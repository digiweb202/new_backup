            ...
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="add-vendor.php" class="btn btn-primary">Add New Vendor</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM vendor WHERE vendor_id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from vendor";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo $row['vendor_password']; ?></td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="?delete=<?php echo $row['vendor_id']; ?>"><i class="bi bi-trash me-3"></i>Delete</a></li>
                                                                    <li><a class="dropdown-item" href="edit-vendor.php?id=<?php echo $row['vendor_id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
