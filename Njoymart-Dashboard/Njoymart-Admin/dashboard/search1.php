                            ...
                            <div class=" px-6 py-6 ">
                                <div class="row justify-content-between">
                                    <div class="col-lg-4 col-md-6 col-12 mb-2 mb-md-0">
                                        <!-- form -->
                                        <form class="d-flex" action="subcategories.php?search" method="POST" role="search">
              ...
              ?>
                            ...
                            <div class="card-body p-0">
                                ...
                                <div class="table-responsive ">
                                    <table class="table table-centered table-hover mb-0 text-nowrap table-borderless table-with-checkbox">
                                        ...
                                        <tbody>
                                            <?php
                                           $select_category = "SELECT * FROM sub_cat WHERE sub_cat_name LIKE '%" . $_REQUEST['search_sub_cat'] . "%'";
                ...
                ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="#!"> <img src="<?php echo $row['sub_cat_img'];?>" alt="Pic"
                              class="icon-shape icon-sm"></a>
                                                </td>
                                                <td><a href="#" class="text-reset"><?php echo $row['sub_cat_name'];?></a></td>
                                                <td>
                                                    <?php 
                                                    $count_product="select count(product_id) as t from product p inner join sub_cat sc on sc.sub_cat_id=p.sub_cat_id INNER join category c on c.cat_id=sc.cat_id where sc.sub_cat_id='$row[sub_cat_id]';";
