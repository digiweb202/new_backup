...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $stmt = $conn->prepare("UPDATE social_media_links SET platform=?, link=? WHERE id=?");
        if ($fileName) {
            $stmt->bind_param("sssi", $title, $link,  $id);
        } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="social-media.php" class="text-inherit">Social Media</a></li>
                                ...
                                <!-- button -->
                                <div>
                                    <a href="social-media.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Social Media</h4>
                                    <div class="row">
                                        <!-- input -->
