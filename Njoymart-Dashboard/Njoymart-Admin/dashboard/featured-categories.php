            ...
            <div class="container">
                    ...
                    <div class="col-md-12">
                        <div class="d-md-flex justify-content-between align-items-center">
                            ...
                            <div>
                                ...
                                <a href="add-featured-categories.php" class="btn btn-primary">Add New Featured Categories</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-6">
                                    <div class="row justify-content-between">
                                        <div class="col-md-4 col-12">
                                            <!-- <form class="d-flex" role="search" action="featured-categories.php?search" method="GET">
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "SELECT * FROM featured_categories WHERE category_name LIKE '%" . $_GET['search'] . "%'";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div class="ms-2">
                                                                    <a href="#" class="text-inherit"><?php echo $row['category_name']; ?></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td><?php echo $row['categories_link']; ?></td>
                                                        <td>
                                                            <?php
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM featured_categories WHERE category_id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_categories = "Select * from featured_categories";
                                                $res_select_customer = $conn->query($select_categories);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center">
                                                                <div class="ms-2">
                                                                    <a href="#" class="text-inherit"><?php echo $row['category_id']; ?></a>
                                                                </div>
                                                            </div>
                                                        </td>
                                                        ...
                                                        <td><?php echo $row['item_count']; ?></td>
                                                        <td>
                                                            <img style="width:150px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/shop/<?php echo $row['image']; ?>" alt="img" class="icon-shape icon-md">
                                                        </td>
                                                        <td><?php echo $row['categories_link']; ?></td>
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    <li><a class="dropdown-item" href="?delete=<?php echo $row['category_id']; ?>"><i class="bi bi-trash me-3"></i>Delete</a></li>
                                                                    <li><a class="dropdown-item" href="edit-featured-categories.php?category_id=<?php echo $row['category_id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
