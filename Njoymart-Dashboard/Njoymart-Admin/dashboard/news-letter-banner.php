            ...
            <div class="container">
                            ...
                            <div>
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item active" aria-current="page">News Letter Content</li>
                                    </ol>
                                </nav>
                            </div>
                            <div>
                                ...
                                <a href="add-news-letter-content.php" class="btn btn-primary">Add New News Letter Content</a>
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="p-6">
                                    <div class="row justify-content-between">
                                        <div class="col-md-4 col-12">
                                            <form class="d-flex" role="search" action="news-letter-banner.php?search" method="GET">
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "SELECT * FROM newsletter_content WHERE customer_name LIKE '%" . $_GET['search'] . "%'";
                ...
                ?>
                    ...
                    if (isset($_GET['delete'])) {
                        ...
                        $delete_query = "DELETE FROM newsletter_content WHERE id = $delete_id";
                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from newsletter_content";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img style="width:200px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/banner/<?php echo $row['image_url']; ?>" alt="img" class="icon-shape icon-md">
                                                        </td>
                                                        <td>
                                                            <div class="dropdown">
                                                                <a href="#" class="text-reset" data-bs-toggle="dropdown" aria-expanded="false">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit-news-letter-content.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
