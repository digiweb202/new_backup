...
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/banner/"; // specify the directory where you want to store the uploaded files
...
if (isset($_POST["submit"])) {
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $targetFile)) {
            ...
            $title = $_POST['title'];
            $link = $_POST['description']; // Added line for the link

            $sql = "INSERT INTO newsletter_content (heading, description, image_url) VALUES ('$title',  '$link','$fileName')";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 col-lg-6">
                                            ...
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Enter description:
                                                <input type="text" name="description" aria-rowspan="" required>
                                                <br><br>
