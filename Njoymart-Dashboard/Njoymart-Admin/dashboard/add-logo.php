...
?>
<?php
$targetDir = "C:/xampp1/htdocs/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/"; // specify the directory where you want to store the uploaded files
