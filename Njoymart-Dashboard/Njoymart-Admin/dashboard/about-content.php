                                ...
                                <div class="card-body p-0 ">
                                    <div class="table-responsive">
                                        <table class="table table-centered table-hover table-borderless mb-0 table-with-checkbox text-nowrap">
                                            ...
                                            <tbody>
                                                <?php
                                                $select_customer = "Select * from about_content";
                                                $res_select_customer = $conn->query($select_customer);
                                                while ($row = mysqli_fetch_assoc($res_select_customer)) {
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img style="width:200px; height:100px" src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/about_assets/<?php echo $row['image_path']; ?>" alt="img" class="icon-shape icon-md">
                                                        </td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li><a class="dropdown-item" href="edit-about-content.php?id=<?php echo $row['id']; ?>"><i class="bi bi-pencil-square me-3 "></i>Edit</a></li>
                                                                </ul>
                                                            </div>
                                                        </td>
                                                    </tr>
