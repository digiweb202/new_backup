...
if (isset($_POST["submit"])) {
    if (isset($_POST['id'])) {
        ...
        $title = $_POST['title'];
        $link = $_POST['link'];
        $title_tag = $_POST['titletag'];

        // Use prepared statements to prevent SQL injection
        $stmt = $conn->prepare("UPDATE footer_links SET link_name=?, link_url=?, title_tag=? WHERE id=?");
        if ($fileName) {
            $stmt->bind_param("sssi", $title, $link, $title_tag, $id);
        } else {
            $stmt->bind_param("sssi", $title, $link, $title_tag, $id);
        }
...
if ($id) {
    ...
    if ($result->num_rows > 0) {
        ...
        $existingText = $row['link_name'];
        $existingLink = $row['link_url'];
        $existingTag = $row['title_tag'];
    } else {
                    ...
                    <div class="row mb-8">
                        <div class="col-md-12">
                            <div class="d-md-flex justify-content-between align-items-center">
                                <!-- page header -->
                                <div>
                                    <h2>Update Footer Pages</h2>
                                    <!-- breacrumb -->
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            <li class="breadcrumb-item"><a href="index.php" class="text-inherit">Dashboard</a></li>
                                            <li class="breadcrumb-item"><a href="footer-links.php" class="text-inherit">Footer Pages</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Update Footer Pages</li>
                                        </ol>
                                    </nav>
                                </div>
                                <!-- button -->
                                <div>
                                    <a href="footer-links.php" class="btn btn-light">Back</a>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-12">
                            ...
                            <div class="card mb-6 card-lg">
                                ...
                                <div class="card-body p-6 ">
                                    <h4 class="mb-4 h5">Footer Pages</h4>
                                    <div class="row">
                                        <!-- input -->
                                        <div class="mb-3 col-lg-6">
                                            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                                                ...
                                                <br><br>
                                                Enter Title Tag:
                                                <input type="text" name="titletag" value="<?php echo isset($existingTag) ? $existingTag : ''; ?>">
                                                <br><br>
