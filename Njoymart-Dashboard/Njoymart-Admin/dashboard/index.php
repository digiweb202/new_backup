...
// Your existing code
$select_admin = "SELECT * FROM admin WHERE admin_id = $adminId";
$res_select_admin = $conn->query($select_admin);

if ($res_select_admin->num_rows > 0) {
    while ($row = $res_select_admin->fetch_assoc()) {
  ...
  <a href="' . $link . '"><img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                    ...
                    <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                        <ul class="navbar-nav flex-column" id="sideNavbar">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="../dashboard/footer_contact.php">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"> <i class="bi bi-people"></i></span>
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="../dashboard/customer.php">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"> <i class="bi bi-star"></i></span>
                                        <span class="nav-link-text">Customer
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="../dashboard/vendor.php">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"> <i class="bi bi-star"></i></span>
                                        <span class="nav-link-text">Vendor
                ...
                <div class="navbar-vertical">
                    ...
                    <div class="navbar-vertical-content flex-grow-1" data-simplebar="">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link " href="../dashboard/watches.php">
                                    <div class="d-flex align-items-center">
                                        <span class="nav-link-icon"> <i class="bi bi-cart"></i></span>
                                        <span class="nav-link-text">Watches</span>
                                    </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card bg-light border-0 rounded-4" style="background-image: url(../assets/images/slider/slider-image-1.jpg); background-repeat: no-repeat; background-size: cover; background-position: right;">
                                <div class="card-body p-lg-12">
                                    ...
                                    <h1>Welcome back!
                                        <?php
                                        // Assuming $adminId contains the ID of the logged-in admin
                                        if (isset($adminId)) {
                                            echo "<h1>{$adminId}</h1>";
                                        }
                                        ?>
                                    ...
                                    <p>FreshCart is simple & clean design for developer and designer.
                                    </p>
