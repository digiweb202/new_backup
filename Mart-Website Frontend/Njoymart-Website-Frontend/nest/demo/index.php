<?php
session_start();
require 'functions.php'; // Assuming the functions.php file contains necessary functions

$conn = getconnection(); // Assuming getconnection() is a function that returns the database connection
...
function make_slides($connect)
{
    ...
    while ($row = mysqli_fetch_array($result)) {
        ...
        $output .= '
   <img src="assets/imgs/slider/' . $row["banner_image"] . '" alt="' . $row["banner_title"] . '" />
...
<body>
                ...
                <div class="modal-body">
                    <div class="deal" style="background-image: url('assets/imgs/banner/popup-1.png')">
                        ...
                        <div class="deal-bottom"> 
                            ...
                            <a href="shop-grid-right.php" class="btn hover-up">Shop Now <i class="-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-4">
                        <div class="text-center">
                            <div id="news-flash" class="d-inline-block" style="overflow: hidden; position: relative; height: 13.9931px;">
                                <ul style="position: absolute; margin: 0px; padding: 0px; top: 0px;">



                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.477562;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    ...
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px; opacity: 0.547054;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px;">Supper Value Deals - Save more with coupons</li>
                                    <li style="margin: 0px; padding: 0px; height: 13.9931px;">Supper Value Deals - Save more with coupons</li>
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info header-info-right">
                            <ul>
                                ...
                                <li>
                                    <a class="language-dropdown-active" href="#">English <i class="fa fa-angle-small-down"></i></a>
                                ...
                                <li>
                                    <a class="language-dropdown-active" href="#">USD <i class="fa fa-angle-small-down"></i></a>
                                    <ul class="language-dropdown">
                                        <li>
            ...
            <div class="container">
                <div class="header-wrap">
                    ...
                    if ($result->num_rows > 0) {
                      ...
                      <a href="' . $link . '"><img src="assets/imgs/theme/' . $imageSource . '" alt="logo"></a>
                  </div>';
                        }
                    } else {
                        echo "0 results";
                    ...
                    <div class="header-right">
                        <div class="search-style-2">
                            <form action="#">
                                ...
                                </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="2" style="width: 140px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-7itr-container"><span class="select2-selection__rendered" id="select2-7itr-container" role="textbox" aria-readonly="true" title="All Categories">All Categories</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                            ...
                            <div class="header-action-2">
                                <div class="search-location">
                                    <form action="#">
                                        ...
                                        </select><span class="select2 select2-container select2-container--default" dir="ltr" data-select2-id="5" style="width: 307.986px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="false" tabindex="0" aria-labelledby="select2-y9c8-container"><span class="select2-selection__rendered" id="select2-y9c8-container" role="textbox" aria-readonly="true" title="Your Location">Your Location</span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span>
                                    </form>
                                </div>
                                 ...
                                 <span class="lable ml-0">Account</span>
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2 account-dropdown">
                                        <ul>
                                            ...
                                            <?php } else { ?>
                                                <li>
                                                    <a href="page-login.php"><i class="fi fa fa-sign-out mr-10"></i>Customer Login/Sign UP</a>
                                                </li>
                                                <li>
            ...
            <div class="mobile-header-content-area">
                ...
                <div class="mobile-header-info-wrap">
                    <div class="single-mobile-header-info">
                        <a href="page-contact.php"><i class="fa fa-marker"></i> Our location </a>
                    </div>
                    <div class="single-mobile-header-info">
    ...
    <main class="main">
        ...
        function get_category_names($conn)
        {
            $sql = "SELECT category_name FROM featured_categories";
            $result = $conn->query($sql);
            $categories = array();
                ...
                <div class="section-title">
                    <div class="title">
                        ...
                        <ul class="list-inline nav nav-tabs links">
                            <?php
                            /*
                                $catNamesArray = get_category_names($conn);
                                foreach ($catNamesArray as $catName) {
                                <li class="list-inline-item nav-item"><a class="nav-link" href="#"><?php echo $catName; ?></a></li>
                                }
                            */
                            ?>
                        ...
                        ?>
                            <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                                <figure class="img-hover-scale overflow-hidden">
                                    <a href="<?php echo $category['categories_link']; ?>"><img src="assets/imgs/shop/<?php echo $category['image']; ?>" alt="" /></a>
                                </figure>
                                <h6><a href="<?php echo $category['categories_link']; ?>"><?php echo $category['category_name']; ?></a></h6>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                            ...
                            <div class="banner-text">
                                ...
                                <a href="shop-grid-right.php" class="btn btn-xs">Shop Now <i class="fa fa-arrow-small-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
        ...
        <section class="banners mb-25">
            <div class="container">
                <div class="row">
                    ...
                    $connect = mysqli_connect("localhost", "root", "", "demo_db");
                    $sql = "SELECT * FROM cart_banner_3";
                    $result = mysqli_query($connect, $sql);

                    // Loop through each row in the result set
                    $delays = [0, 0.2, 0.4]; // Delays for the wow animation
                    $count = 0;
                    while ($row = mysqli_fetch_assoc($result)) {
                        $image = $row['image'];
                        $text = $row['text'];
                        $link = $row['link']; // Assuming you have a 'link' column in your database

                        // Output the dynamic HTML
                        $class = ($count === 2) ? ' d-md-none d-lg-flex' : '';
                        echo '<div class="col-lg-4 col-md-6' . $class . '">';
                        echo '<div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="' . $delays[$count] . 's">';
                        echo '<img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/banner/' . $image . '" alt="" />';
                        echo '<div class="banner-text">';
                        echo '<h4>' . $text . '</h4>';
                        echo '<a href="' . $link . '" class="btn btn-xs">Shop Now <i class="fa fa-arrow-small-right"></i></a>';
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        $count++;
                                ...
                                <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn" data-wow-delay=".1s">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label="Compare" class="action-btn" href="shop-compare.html"><i class="fa fa-shuffle"></i></a>
                                    ...
                                    <div class="product-content-wrap">
                                        ...
                                        <div class="product-card-bottom">
                                            ...
                                            <div class="add-cart">
                                                <a class="add" href="shop-cart.php"><i class="fa fa-shopping-cart mr-5"></i>Add </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                        ...
                        // Assuming you have already established a connection to your database
                        $connect = mysqli_connect("localhost", "root", "", "demo_db");
                        $sql = "SELECT * FROM dbs_cart_banner_1";
                        $result = mysqli_query($connect, $sql);
                        ?>
                        ...
                        if ($result && $result->num_rows > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                $heading = $row['heading'];
                                $link = $row['link'];
                                echo '<div class="banner-img style-2" style="background-image:url(\'assets/imgs/banner/' . $row["background_image"] . '\')">';

                                echo '<div class="banner-text">';

                                echo '<h2 class="mb-100">' . $heading . '</h2>';
                                echo '<a href="' . $link . '" class="btn btn-xs">Shop Now <i class="fa fa-arrow-small-right"></i></a>';
                            ...
                            echo '<div class="banner-img style-2" style="background-image:url(\'default-image.jpg\')">';

                            echo '<div class="banner-text">';
                            echo '<h2 class="mb-100">Default Heading</h2>';
                            echo '<a href="shop-grid-right.php" class="btn btn-xs">Shop Now <i class="fa fa-arrow-small-right"></i></a>';
                            echo '</div>';
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    ...
                                                    <a aria-label="Add To Wishlist" class="action-btn small hover-up" href="shop-wishlist.php"><i class="fa fa-heart"></i></a>
                                                    <a aria-label="Compare" class="action-btn small hover-up" href="shop-compare.php"><i class="fa fa-shuffle"></i></a>
                                                </div>
                                                <div class="product-badges product-badges-position product-badges-mrg">
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <a href="shop-cart.php" class="btn w-100 hover-up"><i class="fa fa-shopping-cart mr-5"></i>Add To Cart</a>
                                            </div>
                                        </div>
                                        <!--End product Wrap-->
                                        <div class="product-cart-wrap">
                ...
                <div class="row">
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        ...
                        <div class="product-list-small animated animated">
                            <?php
                            $top_selling = "SELECT v.brand_name,pa.size,pa.color,pa.price,pa.sku,oi.product_id,p.product_name, DENSE_RANK() OVER (ORDER BY product_id) AS dense_rank FROM order_item oi inner join product p on 
                            p.product_id=oi.product_id inner join vendor v on v.vendor_id=p.vendor_id inner join product_attributes pa on pa.product_try_id=p.product_id limit 3;";
                            $res_top_selling = $conn->query($top_selling);
                            while ($rows = mysqli_fetch_assoc($res_top_selling)) {
                                $rank = $rows['dense_rank'];
                            ?>
                                <article class="row align-items-center hover-up">
                                    <figure class="col-md-4 mb-0">
                                        <a href="shop-product-full.php?sku=<?php echo $rows['sku']; ?>"><img src="assets/imgs/shop/thumbnail-1.jpg" alt="" /></a>
                                    </figure>
                                    <div class="col-md-8 mb-0">
                                        <h6>
                                            <a href="shop-product-full.php?sku=<?php echo $rows['sku']; ?>"><?php echo $rows['brand_name'] . " " . $rows['product_name'] . " " . $rows['size']; ?></a>
                                        </h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                        ...
                                        <div class="product-price">
                                            ...
                                            <span class="old-price"><?php echo $rank; ?></span>
                                        </div>
                                    </div>
                                </article>
                            <?php
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        ...
                        <div class="product-list-small animated animated">
                            <?php
                            $recently_added = "SELECT * FROM `product` ORDER BY created_on DESC limit 3";
                            $result_recently_added = $conn->query($recently_added);
                            while ($added = mysqli_fetch_assoc($result_recently_added)) {
                            ?>
                                <article class="row align-items-center hover-up">
                                    <figure class="col-md-4 mb-0">
                                    ...
                                    <div class="col-md-8 mb-0">
                                        <h6>
                                            <a href="shop-product-right.php"><?php echo $added['product_name'] ?></a>
                                        </h6>
                                        <div class="product-rate-cover">
                                            <div class="product-rate d-inline-block">
                                                <div class="product-rating" style="width: 90%"></div>
                                        ...
                                        <div class="product-price">
                                            <span>₹<?php echo $added['product_price']; ?></span>
                                            <span class="old-price">₹<?php echo $added['product_price']; ?></span>
                                        </div>
                                    </div>
                                </article>
                            <?php
