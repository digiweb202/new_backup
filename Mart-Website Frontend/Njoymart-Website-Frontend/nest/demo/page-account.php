...
if (isset($_SESSION['customer_loggedin'])) {
    if (($_SESSION['customer_loggedin'] == TRUE)) {
                    ...
                    <div class="mobile-header-content-area">
                                ...
                                <ul class="mobile-menu font-heading">
                                    <li class="menu-item-has-children">
                                        ...
                                        <ul class="dropdown">
                                            ...
                                            <li><a href="index.php">Home 6</a></li>
                                        </ul>
                                    </li>
                                    <li class="menu-item-has-children">
                        ...
                        <div class="mobile-header-info-wrap">
                            <div class="single-mobile-header-info">
                                <a href="page-contact.html"><i class="fa fa -marker"></i> Our location </a>
                            </div>
                            <div class="single-mobile-header-info">
                                <a href="page-login.php"><i class="fa fa -user"></i>Log In / Sign Up </a>
                            </div>
                            <div class="single-mobile-header-info">
                ...
                <div class="page-header breadcrumb-wrap">
                    <div class="container">
                        <div class="breadcrumb">
                            <a href="index.php" rel="nofollow"><i class="fa fa -home mr-5"></i>Home</a>
                                    ...
                                    <div class="col-md-3">
                                        <div class="dashboard-menu">
                                            <ul class="nav flex-column" role="tablist">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" id="track-orders-tab" data-bs-toggle="tab" href="#track-orders" role="tab" aria-controls="track-orders" aria-selected="false"><i class="fa fa -shopping-cart-check mr-10"></i>Track Your Order</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" id="address-tab" data-bs-toggle="tab" href="#address" role="tab" aria-controls="address" aria-selected="true"><i class="fa fa -marker mr-10"></i>My Address</a>
                                                </li>
                                                <li class="nav-item">
                                                ...
                                                <li class="nav-item">
                                                    <a class="nav-link" href="logout.php"><i class="fa fa -sign-out mr-10"></i>Logout</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="tab-pane fade active show" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h3 class="mb-0">Hello <?php echo $name; ?></h3>
                                                    </div>
                                                    <div class="card-body">
                                                        <p>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php
                                                                    $ord = "SELECT * FROM order_new where customer_id='$cid'";
                                                                    $res_ord = $conn->query($ord);
                                                                    while ($row_ord = mysqli_fetch_assoc($res_ord)) {

                                                                    ?>
                                                                        <tr>
                                                                            <td><?php echo $row_ord['order_new_id']; ?></td>
                                                                            <?php
                                                                            $dateString = "$row_ord[order_date]";
                                                                            ...
                                                                            <td><?php echo $row_ord['status']; ?></td>
                                                                            <td>
                                                                                <?php
                                                                                echo "₹ " . $row_ord['total_price'] . "  for " . " Items";
                                                                                ?></td>
                            ...
                            <div class="col">
                                <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                                    ...
                                    <ul class="contact-infor">
                                        ...
                                        <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt="" /><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="8ffceee3eacfc1eafcfba1ece0e2">[email&#160;protected]</a></span></li>
