                        ...
                        <div class="table-responsive shopping-summery">
                            <table class="table table-wishlist">
                                ...
                                <tbody>
                                    ...
                                    // // $prd_cart = "SELECT * from cart_new c inner join product_attributes p on c.pa_id=p.attribute_id inner join product pa on pa.product_id=p.product_try_id inner join vendor v on v.vendor_id=pa.vendor_id where c.customer_id='$cid';";
                                    // $res_prd_cart = $conn->query($prd_cart);
                                    // while ($row = mysqli_fetch_assoc($res_prd_cart)) {
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="image product-thumbnail"><img src="<?php echo $row['product_img']; ?>" alt="##"></td>
                                            <td class="product-des product-name">
                                                <h6 class="mb-5"><a class="product-name mb-10 text-heading" href="shop-product-full.php?sku=<?php echo $sku; ?>"><?php echo $brand . " " . $product_name . " " . $size . " " . $color ?></a></h6>
                                            ...
                                            <td class="price" data-title="Price">
                                                <h4 class="text-body">₹<?php echo $product_price; ?></h4>
                                            </td>
                                            ...
                                            <td class="price" data-title="Price">
                                                <h4 class="text-brand">₹<?php echo $sub_total; ?> </h4>
                                            </td>
                            ...
                            <div class="table-responsive">
                                <table class="table no-border">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="cart_total_amount">
                                                <h4 class="text-brand text-end"><?php 
                                    ...
                                    ?>
                                        ...
                                        <td class="cart_total_amount">
                                            <h5 class="text-heading text-end"><?php $fee; ?></h4></td>
                                                </tr>
                                            <?php
                                                $Total = $final + $fee;
                                            }
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            ...
                            <ul class="contact-infor">
                                ...
                                <li><img src="assets/imgs/theme/icons/icon-email-2.svg" alt=""><strong>Email:</strong><span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="9eedfff2fbded0fbedeab0fdf1f3">[email&#160;protected]</a></span></li>
