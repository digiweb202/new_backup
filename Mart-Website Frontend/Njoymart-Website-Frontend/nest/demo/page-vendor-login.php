...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    $check_query_login = "SELECT * FROM vendor WHERE vendor_email = '$vendor_email' AND vendor_password = '$vendor_password'";
    ...
    if ($result_login->num_rows > 0) {
        ...
        $_SESSION['vendor_names'] =  $user_data['vendor_name'];
        $_SESSION['email'] =  $user_data['vendor_email'];
        $_SESSION['vendor_status'] = $user_data['vendor_status'];
                                ...
                                <div class="login_wrap widget-taber-content background-white">
                                    <div class="padding_eight_all bg-white">
                                        ...
                                        <form method="post">
                                            ...
                                            <!-- <div class="form-group">
                                                <input type="text" required="" name="vendor_mobile" placeholder="vendor Number" pattern="\d{12}" title="Please enter a 12-digit number." />
                                            </div> -->
                                            <div class="form-group">
                                            ...
                                            <div class="login_footer form-group mb-50">
                                                ...
                                                <a class="text-muted" href="page-vendor-register.php">I don't have account?</a>
                                            </div>
                                            <div class="form-group">
