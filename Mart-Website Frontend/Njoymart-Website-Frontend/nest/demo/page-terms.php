            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12 col-lg-12 m-auto">
                        <div class="row">
                            <div class="col-lg-11">
                                <div class="single-page pr-50 mb-lg-0 mb-sm-10">
                                    <?php
                                    ...
                                    // Example query to fetch title and paragraph from the database
                                    $sql = "SELECT title, paragraph FROM terms_service";
                                    $result = $conn->query($sql);

                                    if ($result->num_rows > 0) {
                                        // Output data of each row
                                        while ($row = $result->fetch_assoc()) {
                                            // Use the fetched data to populate your HTML dynamically
                                            echo '<div class="single-content mb-50">';
