                        ...
                        <?php
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo '<img src="/hit/Mart-Website Frontend/Njoymart-Website-Frontend/nest/demo/assets/imgs/about_assets/' . $row["image_path"] . '" alt="" class="border-radius-15 mb-md-3 mb-lg-0 mb-sm-4" />';
                                    echo '</div>';
                                    echo '<div class="col-lg-6">';
                                    echo '<div class="pl-25">';
                                    echo '<h2 class="mb-30">' . $row["title"] . '</h2>';
                                    echo '<p class="mb-25">' . $row["content_1"] . '</p>';
                                    echo '<p class="mb-50">' . $row["content_2"] . '</p>';
                                    echo '</div>';
                                    echo '</div>';
                                }
                            } else {
